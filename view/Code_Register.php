...
<?php
include ('C:/wamp/www/Dropbox/PPE/model/model.php') 
    ?>
<?php
session_start();
...
<?php
   if ($i==0)
   {
	...
	$nomavatar=(!empty($_FILES['avatar']['size']))?move_avatar($_FILES['avatar']):''; 
        ...
        $query=$db->prepare('INSERT INTO utilisateur (MotDePasse,NomCompte,Pseudo,email)
        VALUES (:password, :nomCompte, :pseudo, :email)');
	$query->bindValue(':pseudo', $pseudo, PDO::PARAM_STR);
